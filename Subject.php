   ...
   <body>
      <div id="content">
         ...
         <div id="body">
            ...
            <div id="text">
               <p align="center" class="opac">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To search a subject, enter the complete subject's name:<br /><br />
                  <strong>Engineering Chemistry</strong><br /><br />
                  or just the keyword/s within the subject:<br /><br />	
