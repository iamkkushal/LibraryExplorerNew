         ...
         <div id="header">
            ...
            <div id="menu">
               ...
               <ul style="list-style: none;">
                  <li><a href="Title.php" class="nounderline"><strong>Title</strong></a></li>
                  <li><a href="Subject.php" class="nounderline"><strong>Subject</strong></a></li>
                  <li><a href="Author.php" class="nounderline"><strong>Author</strong></a></li>
               </ul>
            </div>
         </div>
         <div id="body">
            ...
            <div id="text">
               <p align="center" class="opac">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;When searching for a specific title, enter the complete title:<br /><br />
                  <span class="style6"><strong>Introduction to the Design & Analysis of Algorithms</strong></span><br /><br />
                  or just keywords within the title: <br /><br />
                  <span class="style6"><strong>Design & Analysis of Algorithms</strong></span>
               </p>
            </div>
         </div>
         <div id="footer">
